# Generated by Django 3.2.9 on 2021-12-27 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='appli1.category', verbose_name='カテゴリ')),
            ],
            options={
                'ordering': ('-created_at',),
            },
